...
Prompt: "First-time Nucleus setup. Where should the shared config root live? It will contain private identity/voice files under `memory/me/`, shared memory, and per-plugin settings."
